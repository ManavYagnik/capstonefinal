...
describe('Asset Transfer Basic Tests', () => {
    ...
    describe('Test CreateAsset', () => {
        it('should return error on CreateAsset', async () => {
            ...
            let assetTransfer = new AssetTransfer();
            try {
                await assetTransfer.CreateAsset(transactionContext, asset.ID, asset.Item, asset.Size, asset.Owner, asset.AppraisedValue);
    ...
    describe('Test UpdateAsset', () => {
        it('should return error on UpdateAsset', async () => {
            ...
            try {
                await assetTransfer.UpdateAsset(transactionContext, 'asset2', 'Mango', 5, 'Distributor_1', 350);
        ...
        it('should return success on UpdateAsset', async () => {
            ...
            await assetTransfer.UpdateAsset(transactionContext, 'asset1', 'orange', 100, 'Farmer2', 550);
            let ret = JSON.parse(await chaincodeStub.getState(asset.ID));
            let expected = {
                ID: 'asset1',
                Item: 'orange',
